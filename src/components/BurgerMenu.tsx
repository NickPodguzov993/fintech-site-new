...
const BurgerMenu = ({openMenu, theme}:MenuType) => {
    return (
        <div className="w-[360px] h-[432px] px-4 fixed z-30  bg-white rounded-tl-[20px]  rounded-tr-[20px] flex-col justify-start items-center gap-8 inline-flex"
             data-aos="fade-down"
             data-aos-delay="250"
            ...
            <div className="w-12 h-12 p-2.5 rounded-[100px] justify-center items-center gap-2.5 inline-flex">
                <div className="w-4 h-4 p-[2.26px] justify-center items-center flex">
                    <div className="w-[11.49px] h-[11.49px] absolute right-[60px] " onClick={openMenu}><CloseMenuSvg/>
                    </div>
                </div>
            </div>
            <div className="text-zinc-900 text-2xl font-medium font-['Raleway'] leading-9">Меню</div>
                ...
                <div className="self-stretch h-12 px-4 rounded-[50px] justify-center items-center gap-2 inline-flex">
                    <NavLink  to="/contacts">
                        <div className= {`  text-base font-bold font-['Raleway']  sm:block hover:text-rose_theme  leading-relaxed pt-2 
                                `}
                             onClick={openMenu}>Контакты</div>
                    </NavLink>
                </div>
                <div className="self-stretch h-12 px-4 rounded-[50px] justify-center items-center gap-2 inline-flex">
                    <NavLink  to="/policies">
                        <div className={`${theme === 'light' ? 'text-[#1B1B1B]' : 'text-[#fff]'}  
                        text-base font-bold font-['Raleway']  sm:block hover:text-rose-600 leading-relaxed pt-2`} onClick={openMenu}>Документы</div>
                    </NavLink>
                </div>
            </div>
            ...
            <div className="self-stretch py-4 border-t border-neutral-100 justify-start items-center gap-2.5 inline-flex">
                <div className="grow shrink basis-0 text-zinc-900 text-sm font-bold font-['Raleway'] leading-snug">344034, Россия, Ростовская обл., Город Ростов-на-Дону, Портовая ул., 63, Офис 4</div>
            </div>
        </div>
    );
};
