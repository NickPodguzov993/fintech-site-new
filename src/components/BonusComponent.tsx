...
const BonusComponent = (props:BonusComponentType) => {
    ...
    return (
        <div >
            <div onClick={props.onClick} className={` ${props.isActive ? 'bg-rose-600 text-white' : 'bg-white text-rose-600'} 
            ${props.theme === 'light' ? "bg-rose-600 text-rose-600" : "bg-[black] text-white border-none"} px-6 py-4 
